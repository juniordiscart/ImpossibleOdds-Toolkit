...
namespace Tests
{
    public class EnumProcessorTest
    {
        ...
        public void CanSerializeTest()
        {
            ...
            GenericSerializationProcessorTester<EnumProcessor>.CanSerializeTest(processor, supportedTypes, new List<CanSerializeTestData>()
            {
                new CanSerializeTestData()
                {
                    failingValues = new List<object>() { null, string.Empty, "123", 123, 123f },
                    passingValues = new List<object>() { EnumPosition.First, EnumDifficultyMode.Easy, EnumGameModifierFlags.Modifier1 }
                }
            });
        ...
        public void CanDeserializeTest()
        {
            ...
            // Test serialization without alias feature support
            GenericDeserializationProcessorTester<EnumProcessor>.CanDeserializeTest(processor, new List<CanDeserializeTestData>()
            {
