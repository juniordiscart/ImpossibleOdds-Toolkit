	...
	public class VersionProcessorTest
	{
		...
		public void SerializeTests()
		{
			...
			GenericSerializationProcessorTester<VersionProcessor>.SerializeTest(processor, supportedTypes, new List<SerializeTestData>()
			{
				...
				// Serialization definition supports the Version type.
				new SerializeTestData()
				{
					supportedTypes = new List<Type>(){ typeof(Version) },
				...
				// Serialization definition supports the Version and string types.
				new SerializeTestData()
				{
					supportedTypes = new List<Type>(){ typeof(Version) },
					passingValues = new List<SerializeValue>()
			...
			GenericDeserializationProcessorTester<VersionProcessor>.DeserializeTests(processor, new List<DeserializeTestData>()
			{
				new DeserializeTestData()
				{
					throwingValues = new List<DeserializationThrowingValue>()
					{
						...
						new DeserializationThrowingValue(typeof(ArgumentException), typeof(Version), string.Empty),
						new DeserializationThrowingValue(typeof(ArgumentException), typeof(Version), " "),
						new DeserializationThrowingValue(typeof(ArgumentException), typeof(Version), "ABCDE"),
						new DeserializationThrowingValue(typeof(FormatException), typeof(Version), "AB.CD"),
						new DeserializationThrowingValue(typeof(ArgumentException), typeof(Version), "1.2.3.4.5"),
						new DeserializationThrowingValue(typeof(ArgumentException), typeof(Version), "1.2.-3.4."),
					},
