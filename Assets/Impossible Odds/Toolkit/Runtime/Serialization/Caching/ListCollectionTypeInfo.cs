...
{
	/// <summary>
	/// Contains type information about the kist data structure, i.e. whether it restricts its values to be type restricted, and whether it is an array or not.
	/// </summary>
	public class ListCollectionTypeInfo
	{
		/// <summary>
		/// Generic type info of the list.
		/// </summary>
		...
		public ListCollectionTypeInfo(IList instance)
		: this(instance.GetType())
		{ }

		public ListCollectionTypeInfo(Type collectionType)
		{
