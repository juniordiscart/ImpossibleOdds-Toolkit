namespace ImpossibleOdds.DataMapping.Processors
{
	...
	/// </summary>
	public abstract class AbstractCollectionMappingProcessor : AbstractMappingProcessor
	{
		...
		public AbstractCollectionMappingProcessor(IMappingDefinition definition, bool strictTypeChecking = DefaultOptions.StrictTypeChecking)
		: base(definition) { }
		...
		protected bool PassesTypeRestriction(object value, Type elementType)
		{
			...
			bool isNullable = DataMappingUtilities.IsNullableType(elementType);
